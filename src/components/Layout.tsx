            ...
            >
                ...
                <nav className="sidebar-nav">
                    <NavLink to="/" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`} end>
                        ...
                        <motion.span animate={{ opacity: isHovered ? 1 : 0 }} transition={{ duration: 0.2 }}>Dashboard</motion.span>
                    </NavLink>
                    <NavLink to="/clientes" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
                        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
                        <motion.span animate={{ opacity: isHovered ? 1 : 0 }} transition={{ duration: 0.2 }}>Clientes</motion.span>
                    </NavLink>
                    <NavLink to="/tarefas" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
                        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                        </svg>
                        <motion.span animate={{ opacity: isHovered ? 1 : 0 }} transition={{ duration: 0.2 }}>Tarefas</motion.span>
                    </NavLink>
                    <NavLink to="/calendario" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
                        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <motion.span animate={{ opacity: isHovered ? 1 : 0 }} transition={{ duration: 0.2 }}>Calendário</motion.span>
                    </NavLink>
                    ...
                    {isSuperAdmin && (
                        <>
                            <div className="sidebar-admin-divider">
                                <motion.span animate={{ opacity: isHovered ? 1 : 0 }} transition={{ duration: 0.2 }}>ADMIN</motion.span>
                            </div>
                            <NavLink to="/admin/dashboard" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
                                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <motion.span animate={{ opacity: isHovered ? 1 : 0 }} transition={{ duration: 0.2 }}>Dashboard Global</motion.span>
                            </NavLink>
                            <NavLink to="/admin/usuarios" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
                                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                                </svg>
                                <motion.span animate={{ opacity: isHovered ? 1 : 0 }} transition={{ duration: 0.2 }}>Usuários</motion.span>
                            </NavLink>
                            <NavLink to="/admin/relatorios" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
                                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                </svg>
                                <motion.span animate={{ opacity: isHovered ? 1 : 0 }} transition={{ duration: 0.2 }}>Relatórios</motion.span>
                            </NavLink>
                        </>
                    )}
                </nav>
                <div className="sidebar-footer">
                    {!isHovered ? (
                        <NavLink to="/perfil" className="sidebar-footer-icon" title="Meu Perfil">
                            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                        ...
                        <>
                            <NavLink to="/perfil" className="sidebar-user-info" title="Meu Perfil">
